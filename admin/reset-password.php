...
$verified = $_SESSION['admin_reset_verified'] ?? false;
if (!$email || !$verified) { header('Location: /ILSHD/admin/forgot-password.php'); exit; }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$pass || !$confirm) { $error = 'Please fill in both fields.'; }
    ...
    elseif (strlen($pass) < 6)  { $error = 'Password must be at least 6 characters.'; }
        ...
        unset($_SESSION['admin_reset_email'], $_SESSION['admin_reset_verified']);
        $success = true;
    }
}
?>
        ...
        <div class="card shadow-sm border-0 p-4">
            ...
            <?php if ($success): ?>
                <div class="text-center">
                    ...
                    <div class="d-grid">
                        <a href="/ILSHD/admin/login.php" class="btn btn-yellow btn-lg">Back to Login</a>
                    </div>
                </div>
            <?php else: ?>
                <h2 class="h4 mb-2">Create New Password</h2>
                <p class="text-muted mb-4" style="font-size:0.9rem;">Enter your new admin password.</p>
                ...
                <form method="POST" novalidate>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" id="pw1" name="password" class="form-control" placeholder="New password" required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" id="pw2" name="confirm_password" class="form-control" placeholder="Repeat password" required>
